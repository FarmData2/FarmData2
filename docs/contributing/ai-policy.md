...
The current reading of copyright law in the US (and similarly elsewhere in the world) is that **human authorship** is a requirement for copyright protection of artifacts resulting from creative work. Human written source code meets this requirement. However, source code generated by an AI model in response to a human written prompt (at least at this time) does not.


The monkey photograph - there is no copyright...


### Prompting cannot Confer Authorship
