describe('Transplanting: Soil Disturbance Component', () => {
  beforeEach(() => {
  ...
  it('Soil disturbance accordion exists, is visible, is collapsed', () => {
    cy.get('[data-cy="transplanting-soil-disturbance-accordion"]').should(
      'be.visible'
    );
    cy.get('[data-cy="transplanting-soil-disturbance-accordion-title"]')
      .should('be.visible')
  ...
  it('Soil disturbance accordion expands to show equipment selector', () => {
    ...
    cy.get('[data-cy="transplanting-soil-disturbance"]').should('be.visible');
  });
