<template>
  ...
  >
    ...
    -->
    <BToaster
      id="equipment-selector-toaster"
      data-cy="equipment-selector-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="equipment-selector-card"
      data-cy="equipment-selector-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="equipment-selector-header"
          data-cy="equipment-selector-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="equipment-selector-form"
        data-cy="equipment-selector-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="equipment-selector-date"
          data-cy="equipment-selector-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="equipment-selector-comment"
          data-cy="equipment-selector-comment"
        ...
        <SubmitResetButtons
          id="equipment-selector-submit-reset"
          data-cy="equipment-selector-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting EquipmentSelector Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in equipment_selector.submission.e2e.cy.js and
         * equipment_selector.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil
              .showToast(
                'EquipmentSelector Example created.',
                '',
                'top-center',
                'success',
                2
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating EquipmentSelector Example records.',
 ...
 * in the entry point.
 */
#equipment-selector-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#equipment-selector-comment {
  margin-bottom: 15px;
}
</style>
