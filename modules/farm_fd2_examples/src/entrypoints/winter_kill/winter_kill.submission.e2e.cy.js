describe('WinterKill: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting WinterKill...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'WinterKill created.');
  ...
  it('Test submission with network error', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Error creating WinterKill records.');
