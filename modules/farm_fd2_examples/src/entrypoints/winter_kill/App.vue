<template>
  ...
  >
    ...
    -->
    <BToaster
      id="winter-kill-toaster"
      data-cy="winter-kill-toaster"
    />
    <!-- 
    ...
    >
      ...
      <template #header>
        <h2
          id="winter-kill-header"
          data-cy="winter-kill-header"
          class="text-center"
        >
          WinterKill
        </h2>
      ...
      >
        ...
        <!-- Comment Box -->
        <CommentBox
          id="winter-kill-comment"
          data-cy="winter-kill-comment"
        ...
        <SubmitResetButtons
          id="winter-kill-submit-reset"
          data-cy="winter-kill-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         * that the tests in winter_kill.submission.e2e.cy.js and
         * winter_kill.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil.hideToast();
            uiUtil
              .showToast('WinterKill created.', '', 'top-center', 'success', 2)
              .then(() => {
                this.reset(true);
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating WinterKill records.',
