describe('MultiSelectorBase Example: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting MultiSelectorBase Example...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'MultiSelectorBase Example created.');
