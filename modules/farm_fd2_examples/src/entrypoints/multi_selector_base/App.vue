<template>
  ...
  >
    ...
    -->
    <BToaster
      id="multi-selector-base-toaster"
      data-cy="multi-selector-base-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="multi-selector-base-card"
      data-cy="multi-selector-base-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="multi-selector-base-header"
          data-cy="multi-selector-base-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="multi-selector-base-form"
        data-cy="multi-selector-base-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="multi-selector-base-date"
          data-cy="multi-selector-base-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="multi-selector-base-comment"
          data-cy="multi-selector-base-comment"
        ...
        <SubmitResetButtons
          id="multi-selector-base-submit-reset"
          data-cy="multi-selector-base-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting MultiSelectorBase Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in multi_selector_base.submission.e2e.cy.js and
         * multi_selector_base.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil
              .showToast(
                'MultiSelectorBase Example created.',
                '',
                'top-center',
                'success',
                2
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating MultiSelectorBase Example records.',
 ...
 * in the entry point.
 */
#multi-selector-base-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#multi-selector-base-comment {
  margin-bottom: 15px;
}
</style>
