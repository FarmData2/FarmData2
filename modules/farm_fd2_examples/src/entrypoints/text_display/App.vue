<template>
  ...
  >
    ...
    -->
    <BToaster
      id="text-display-toaster"
      data-cy="text-display-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="text-display-card"
      data-cy="text-display-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="text-display-header"
          data-cy="text-display-header"
          class="text-center"
        >
          TextDisplay Example
        </h2>
      ...
      -->
      <BForm
        id="text-display-form"
        data-cy="text-display-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="text-display-date"
          data-cy="text-display-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="text-display-comment"
          data-cy="text-display-comment"
        ...
        <SubmitResetButtons
          id="text-display-submit-reset"
          data-cy="text-display-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting TextDisplay Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in text_display.submission.e2e.cy.js and
         * text_display.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating TextDisplay Example records.',
