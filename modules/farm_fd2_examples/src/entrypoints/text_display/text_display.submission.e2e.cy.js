describe('TextDisplay Example: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting TextDisplay Example...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'TextDisplay Example created.');
  ...
  it('Test submission with network error', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Error creating TextDisplay Example records.');
