<template>
  ...
  >
    ...
    -->
    <BToaster
      id="sort-order-button-toaster"
      data-cy="sort-order-button-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="sort-order-button-card"
      data-cy="sort-order-button-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="sort-order-button-header"
          data-cy="sort-order-button-header"
          class="text-center"
        >
          SortOrderButton
        </h2>
      ...
      -->
      <BForm
        id="sort-order-button-form"
        data-cy="sort-order-button-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="sort-order-button-date"
          data-cy="sort-order-button-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="sort-order-button-comment"
          data-cy="sort-order-button-comment"
        ...
        <SubmitResetButtons
          id="sort-order-button-submit-reset"
          data-cy="sort-order-button-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         * that the tests in sort_order_button.submission.e2e.cy.js and
         * sort_order_button.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating SortOrderButton records.',
 ...
 * in the entry point.
 */
#sort-order-button-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#sort-order-button-comment {
  margin-bottom: 15px;
}
</style>
