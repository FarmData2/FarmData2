<template>
  ...
  >
    ...
    -->
    <BToaster
      id="numeric-input-toaster"
      data-cy="numeric-input-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="numeric-input-card"
      data-cy="numeric-input-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="numeric-input-header"
          data-cy="numeric-input-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="numeric-input-form"
        data-cy="numeric-input-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="numeric-input-date"
          data-cy="numeric-input-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="numeric-input-comment"
          data-cy="numeric-input-comment"
        ...
        <SubmitResetButtons
          id="numeric-input-submit-reset"
          data-cy="numeric-input-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting NumericInput Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in numeric_input.submission.e2e.cy.js and
         * numeric_input.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating NumericInput Example records.',
