<template>
  ...
  >
    ...
    -->
    <BToaster
      id="crop-selector-toaster"
      data-cy="crop-selector-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="crop-selector-card"
      data-cy="crop-selector-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="crop-selector-header"
          data-cy="crop-selector-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="crop-selector-form"
        data-cy="crop-selector-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="crop-selector-date"
          data-cy="crop-selector-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="crop-selector-comment"
          data-cy="crop-selector-comment"
        ...
        <SubmitResetButtons
          id="crop-selector-submit-reset"
          data-cy="crop-selector-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting CropSelector Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in crop_selector.submission.e2e.cy.js and
         * crop_selector.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating CropSelector Example records.',
