describe('CropSelector Example: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting CropSelector Example...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'CropSelector Example created.');
  ...
  it('Test submission with network error', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Error creating CropSelector Example records.');
