describe('CommentBox Example: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting CommentBox Example...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'CommentBox Example created.');
  ...
  it('Test submission with network error', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Error creating CommentBox Example records.');
