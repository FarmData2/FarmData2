<template>
  ...
  >
    ...
    -->
    <BToaster
      id="comment-box-toaster"
      data-cy="comment-box-toaster"
    />
    <!-- 
    ...
    >
      ...
      <template #header>
        <h2
          id="comment-box-header"
          data-cy="comment-box-header"
          class="text-center"
        >
          CommentBox Example
        </h2>
      ...
      >
        ...
        <!-- Comment Box -->
        <CommentBox
          id="comment-box-comment"
          data-cy="comment-box-comment"
        ...
        <SubmitResetButtons
          id="comment-box-submit-reset"
          data-cy="comment-box-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         * that the tests in comment_box.submission.e2e.cy.js and
         * comment_box.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating CommentBox Example records.',
