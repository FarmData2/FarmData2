<template>
  ...
  >
    ...
    -->
    <BToaster
      id="submit-reset-buttons-toaster"
      data-cy="submit-reset-buttons-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="submit-reset-buttons-card"
      data-cy="submit-reset-buttons-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="submit-reset-buttons-header"
          data-cy="submit-reset-buttons-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="submit-reset-buttons-form"
        data-cy="submit-reset-buttons-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="submit-reset-buttons-date"
          data-cy="submit-reset-buttons-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="submit-reset-buttons-comment"
          data-cy="submit-reset-buttons-comment"
        ...
        <SubmitResetButtons
          id="submit-reset-buttons-submit-reset"
          data-cy="submit-reset-buttons-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting SubmitResetButtons Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in submit_reset_buttons.submission.e2e.cy.js and
         * submit_reset_buttons.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil
              .showToast(
                'SubmitResetButtons Example created.',
                '',
                'top-center',
                'success',
                2
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating SubmitResetButtons Example records.',
 ...
 * in the entry point.
 */
#submit-reset-buttons-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#submit-reset-buttons-comment {
  margin-bottom: 15px;
}
</style>
