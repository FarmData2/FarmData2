<template>
  ...
  >
    ...
    -->
    <BToaster
      id="multi-crop-selector-toaster"
      data-cy="multi-crop-selector-toaster"
    />
    <!-- 
    ...
    -->
    <BCard
      id="multi-crop-selector-card"
      data-cy="multi-crop-selector-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="multi-crop-selector-header"
          data-cy="multi-crop-selector-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="multi-crop-selector-form"
        data-cy="multi-crop-selector-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="multi-crop-selector-date"
          data-cy="multi-crop-selector-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="multi-crop-selector-comment"
          data-cy="multi-crop-selector-comment"
        ...
        <SubmitResetButtons
          id="multi-crop-selector-submit-reset"
          data-cy="multi-crop-selector-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting MultiCropSelector Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in multi_crop_selector.submission.e2e.cy.js and
         * multi_crop_selector.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil
              .showToast(
                'MultiCropSelector Example created.',
                '',
                'top-center',
                'success',
                2
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating MultiCropSelector Example records.',
 ...
 * in the entry point.
 */
#multi-crop-selector-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#multi-crop-selector-comment {
  margin-bottom: 15px;
}
</style>
