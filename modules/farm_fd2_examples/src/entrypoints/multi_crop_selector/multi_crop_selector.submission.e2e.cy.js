describe('MultiCropSelector Example: Submission tests', () => {
  beforeEach(() => {
  ...
  it('Test successful submission', () => {
    ...
    cy.get('.toast')
      .should('be.visible')
      .should('contain.text', 'Submitting MultiCropSelector Example...');
    ...
    cy.get('.toast', { timeout: 10000 })
      .should('be.visible')
      .should('contain.text', 'MultiCropSelector Example created.');
