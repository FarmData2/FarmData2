<template>
  ...
  >
    ...
    -->
    <BToaster
      id="location-selector-toaster"
      data-cy="location-selector-toaster"
    />
    <!-- 
    ...
    <BCard
      ...
      data-cy="location-selector-card"
      bg-variant="light"
      header-tag="header"
    >
      <!-- 
      ...
      <template #header>
        <h2
          id="location-selector-header"
          data-cy="location-selector-header"
          class="text-center"
        >
      ...
      -->
      <BForm
        id="location-selector-form"
        data-cy="location-selector-form"
      >
        <!--
        ...
        <!-- Date -->
        <DateSelector
          id="location-selector-date"
          data-cy="location-selector-date"
          required
        ...
        <!-- Comment Box -->
        <CommentBox
          id="location-selector-comment"
          data-cy="location-selector-comment"
        ...
        <SubmitResetButtons
          id="location-selector-submit-reset"
          data-cy="location-selector-submit-reset"
  ...
  methods: {
    ...
    submit() {
      ...
      if (this.validToSubmit) {
         ...
         */
        uiUtil.showToast(
          'Submitting LocationSelector Example...',
          '',
          'top-center',
          'success'
        );
         ...
         * that the tests in location_selector.submission.e2e.cy.js and
         * location_selector.submitError.e2e.cy.js have their own copy that
        ...
        lib
          ...
          .then(() => {
            ...
            uiUtil
              .showToast(
                'LocationSelector Example created.',
                '',
                'top-center',
                'success',
                2
          ...
          .catch(() => {
            ...
            if (!this.errorShown) {
              ...
              uiUtil
                .showToast(
                  'Error creating LocationSelector Example records.',
 ...
 * in the entry point.
 */
#location-selector-date {
  margin-top: 2px;
  margin-bottom: 8px;
}

#location-selector-comment {
  margin-bottom: 15px;
}
</style>
