 ...
 * @param {boolean} showValidityStyling - the value of the `showValidityStyling` prop in the component.
 ...
 */
export function validityStyling(isValid, showValiditytyling) {
  if (showValiditytyling) {
    return isValid;
  } else {
    return null;
  }
